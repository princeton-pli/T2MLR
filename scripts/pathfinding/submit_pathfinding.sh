#!/usr/bin/env bash
# Submitter for pathfinding training sweeps.
...
SFT_RUN_NAME_BASE="${SFT_RUN_NAME_BASE:-pathfinding_t2mlr}"
LOG_DIR="${LOG_DIR:-$REPO_ROOT/scripts/pathfinding/slurm}"
TRAIN_SCRIPT="${TRAIN_SCRIPT:-$REPO_ROOT/scripts/pathfinding/train_pathfinding.sh}"
SWEEP_PARAMS_YAML="${SWEEP_PARAMS_YAML:-$REPO_ROOT/scripts/pathfinding/sweep_params.yaml}"
