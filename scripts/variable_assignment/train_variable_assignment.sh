...
DATASET_SLUG="${DATASET_SLUG:-variable_assignment}"
...
PER_DEVICE_TRAIN_BATCH="${PER_DEVICE_TRAIN_BATCH:-128}"
PER_DEVICE_EVAL_BATCH="${PER_DEVICE_EVAL_BATCH:-256}"
GRADIENT_ACCUMULATION_BASE="${GRADIENT_ACCUMULATION_BASE:-2}"
...
TRAIN_DATA_PATH="${TRAIN_DATA_PATH:-$DATA_ROOT/variable_assignment/train.jsonl}"
EVAL_DATA_PATH="${EVAL_DATA_PATH:-$DATA_ROOT/variable_assignment/test.jsonl}"
