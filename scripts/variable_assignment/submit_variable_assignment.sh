#!/usr/bin/env bash
# Simple submitter for variable-assignment training sweeps (train only, no eval).
...
SFT_RUN_NAME_BASE="${SFT_RUN_NAME_BASE:-variable_assignment_t2mlr}"
LOG_DIR="${LOG_DIR:-$REPO_ROOT/scripts/variable_assignment/slurm}"
TRAIN_SCRIPT="${TRAIN_SCRIPT:-$REPO_ROOT/scripts/variable_assignment/train_variable_assignment.sh}"
SWEEP_PARAMS_YAML="${SWEEP_PARAMS_YAML:-$REPO_ROOT/scripts/variable_assignment/sweep_params.yaml}"
