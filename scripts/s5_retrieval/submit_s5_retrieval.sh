#!/usr/bin/env bash
# Submitter for S5 retrieval training sweeps.
...
SFT_RUN_NAME_BASE="${SFT_RUN_NAME_BASE:-s5_retrieval}"
LOG_DIR="${LOG_DIR:-$REPO_ROOT/scripts/s5_retrieval/slurm}"
TRAIN_SCRIPT="${TRAIN_SCRIPT:-$REPO_ROOT/scripts/s5_retrieval/train_s5_retrieval.sh}"
SWEEP_PARAMS_YAML="${SWEEP_PARAMS_YAML:-$REPO_ROOT/scripts/s5_retrieval/sweep_params.yaml}"
